...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_swap" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#0872ae86#;
   pragma Export (C, u00001, "swapB");
   ...
   u00082 : constant Version_32 := 16#1f488a30#;
